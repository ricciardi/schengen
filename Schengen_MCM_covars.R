...
for(o in outcome.vars){
  ...
  boot.trajectory.swiss <- tsboot(tseries=ts(t(outcomes.cbw$M)), MCEstBoot, mask=outcomes.cbw$mask, W=outcomes.cbw$W, X=outcomes.cbw$X,X.hat=outcomes.cbw$X.hat,swiss=outcomes.cbw$swiss, covars=TRUE, rev=TRUE, t0=t0_eastern.swiss, R=1000, parallel = "multicore", l=bopt, sim = "geom") 
  ...
  boot.trajectory.control <- tsboot(tseries=ts(t(outcomes.cbw$M)), MCEstBoot, mask=outcomes.cbw$mask, W=outcomes.cbw$W, X=outcomes.cbw$X,X.hat=outcomes.cbw$X.hat,control=outcomes.cbw$control, covars=TRUE, rev=TRUE, t0=t0_control.cbw, R=1000, parallel = "multicore", l=bopt, sim = "geom") 
  saveRDS(boot.trajectory.control, paste0("results/boot-trajectory-control-cbw-",o,"-covars.rds")) 
  ...
  boot.trajectory.swiss <- tsboot(tseries=ts(t(outcomes.lm$M)), MCEstBoot, mask=outcomes.lm$mask, W=outcomes.lm$W, swiss=outcomes.lm$swiss, X=outcomes.lm$X,X.hat=outcomes.lm$X.hat,covars=TRUE, rev=FALSE, t0=t0_eastern.swiss, R=1000, parallel = "multicore", l=bopt, sim = "geom") 
  ...
  boot.trajectory.control <- tsboot(tseries=ts(t(outcomes.lm$M)), MCEstBoot, mask=outcomes.lm$mask, W=outcomes.lm$W, control=outcomes.lm$control,X=outcomes.lm$X,X.hat=outcomes.lm$X.hat, covars=TRUE, rev=FALSE, t0=t0_control.lm, R=1000, parallel = "multicore", l=bopt, sim = "geom") 
  saveRDS(boot.trajectory.control, paste0("results/boot-trajectory-control-lm-",o,"-covars.rds")) 
