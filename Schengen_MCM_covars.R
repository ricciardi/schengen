...
for(o in outcome.vars){
  ...
  print(paste0("Covariates + NO FIXED EFFECTS, outcome:",o))
  
  # Get treatment effect estimates
  
  mc.estimates.cbw <- MCEst(outcomes.cbw, rev=TRUE, covars=TRUE, fe=FALSE)
  saveRDS(mc.estimates.cbw, paste0("results/mc-estimates-cbw-",o,"-covars-no-fe.rds"))
  
  print(paste0("Rank of L: ", mc.estimates.cbw$rankL))
  
  # Bootstrap for per-period effects

  boot <- tsboot(tseries=ts(t(outcomes.cbw$M)), MCEstBoot, mask=outcomes.cbw$mask, W=outcomes.cbw$W, X=outcomes.cbw$X,X.hat=outcomes.cbw$X.hat, covars=TRUE, rev=TRUE, fe=FALSE, R=999, parallel = "multicore", l=bopt, sim = "geom") 
  saveRDS(boot, paste0("results/boot-cbw-",o,"-covars-no-fe.rds")) 
  ...
  saveRDS(boot.trajectory.eastern, paste0("results/boot-cbw-trajectory-eastern-",o,"-covars-no-fe.rds")) 
  ...
  saveRDS(boot.trajectory.eastern.08, paste0("results/boot-cbw-trajectory-eastern-08-",o,"-covars-no-fe.rds")) 
  ...
  saveRDS(boot.trajectory.eastern.09, paste0("results/boot-cbw-trajectory-eastern-09-",o,"-covars-no-fe.rds")) 
  ...
  saveRDS(boot.trajectory.swiss, paste0("results/boot-cbw-trajectory-swiss-",o,"-covars-no-fe.rds")) 
  ...
  saveRDS(boot.trajectory.swiss.07, paste0("results/boot-cbw-trajectory-swiss-07-",o,"-covars-no-fe.rds")) 
  ...
  saveRDS(boot.trajectory.swiss.08, paste0("results/boot-cbw-trajectory-swiss-08-",o,"-covars-no-fe.rds"))  
}