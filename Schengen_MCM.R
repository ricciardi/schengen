...
for(o in outcome.vars){
  ...
  boot.trajectory.swiss <- tsboot(tseries=ts(t(outcomes.cbw$M)), MCEstBoot, mask=outcomes.cbw$mask, W=outcomes.cbw$W, swiss=outcomes.cbw$swiss, covars=FALSE, rev=TRUE, t0=t0_swiss.cbw, R=1000, parallel = "multicore", l=bopt, sim = "geom") 
