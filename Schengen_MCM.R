...
for(o in outcome.vars){
  ...
  boot <- tsboot(tseries=ts(t(outcomes.cbw.eastern$M)), MCEstBoot, mask=outcomes.cbw.eastern$mask, W=outcomes.cbw.eastern$W, treated=outcomes.cbw.eastern$treated, control=outcomes.cbw.eastern$control, covars=NULL,R=1000, parallel = "multicore", l=bopt, sim = "fixed") 
  ...
  boot <- tsboot(tseries=ts(t(outcomes.cbw.swiss$M)), MCEstBoot, mask=outcomes.cbw.swiss$mask, W=outcomes.cbw.swiss$W, treated=outcomes.cbw.swiss$treated, control=outcomes.cbw.swiss$control, covars=NULL,R=1000, parallel = "multicore", l=bopt, sim = "fixed") 
  ...
  boot <- tsboot(tseries=ts(t(outcomes.lm.eastern$M)), MCEstBoot, mask=outcomes.lm.eastern$mask, W=outcomes.lm.eastern$W, treated=outcomes.lm.eastern$treated, control=outcomes.lm.eastern$control, covars=NULL,R=1000, parallel = "multicore", l=bopt, sim = "fixed") 
  ...
  boot <- tsboot(tseries=ts(t(outcomes.lm.swiss$M)), MCEstBoot, mask=outcomes.lm.swiss$mask, W=outcomes.lm.swiss$W, treated=outcomes.lm.swiss$treated, control=outcomes.lm.swiss$control, covars=NULL,R=1000, parallel = "multicore", l=bopt, sim = "fixed") 
