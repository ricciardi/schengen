...
for(o in outcome.vars){
  ...
  iid.block.placebo.eastern <- lapply(taus, function(t){
    ...
    ChernoTest(outcomes=outcomes.cbw.placebo[c("M","mask","W")], ns=1000, q=1,treat_indices_order=outcomes.cbw$eastern, permtype="iid.block",t0=t0_placebo,rev=TRUE,covars=FALSE)
  ...
  saveRDS(iid.block.placebo.eastern,paste0("results/iid-block-placebo-cbw-eastern",o,".rds"))
    ...
    t0_placebo <- t_final_placebo-t # n pre-treatment periods
    ChernoTest(outcomes=outcomes.cbw.placebo[c("M","mask","W")], ns=1000, q=1,treat_indices_order=outcomes.cbw$swiss, permtype="iid.block",t0=t0_placebo,rev=TRUE,covars=FALSE)
